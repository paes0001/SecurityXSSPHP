...
<body>
  <header class="w3-container w3-theme">
    <h1 class="w3-serif">Secure Blog</h1>
  </header>
    ...
    <section class="w3-cell w3-mobile w3-container w3-padding-16 w3-theme-d5 " style="width: 50%; margin: auto;">
      ...
      foreach ($comments as $comment) { ?>
        <div class="w3-panel w3-padding-large w3-theme-l4">
          ...
          <textarea class="w3-input w3-theme-l4" style="resize: none; border: none; padding:0%;" readonly><?php print($comment['Comment']) ?></textarea>
