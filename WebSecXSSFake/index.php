...
if (isset($_POST["submit"])) {
  ...
  if ($_POST["name"] == "") {
    $errorName = "*This is a bad error!";
  }

  if ($_POST["comment"] == "") {
    $errorComment = "*Your computer will crash!!!";
  }
}

$comments = [
  array('Name' => 'Doc', 'Comment' => 'Look, our house! The lit’s light—the light’s lit!'),
  array('Name' => 'Grumpy', 'Comment' => 'Mark my words, there’s trouble a-brewin’.'),
  array('Name' => 'Bashful', 'Comment' => 'My cup’s been washed. Sugar’s gone!'),
  array('Name' => 'Sneezy', 'Comment' => 'Sink’s empty. Hey, someone stole our dishes!'),
  array('Name' => 'Happy', 'Comment' => 'I’ll take a chance for her.'),
